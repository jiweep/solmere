...
// ============================================================================
G.TOWNS = [
  { id: 'brinehollow', name: 'Brinehollow', x: 72, y: 178, map: 'brinehollow', fx: 18, fy: 9, fly: true, desc: 'A sleepy seaside village where every journey starts.' },
  { id: 'fernwick', name: 'Fernwick Town', x: 58, y: 120, map: 'fernwick', fx: 21, fy: 19, fly: true, desc: 'A town of flowers, home of Warden Juniper.' },
  { id: 'whisperwood', name: 'Whisperwood', x: 92, y: 80, map: 'whisperwood', fly: false, desc: 'An old forest guarding the Heartroot Shrine.' },
  { id: 'galvan', name: 'Galvan Harbor', x: 140, y: 58, map: 'galvan', fx: 22, fy: 19, fly: true, desc: 'A bustling port powered by Crane Dynamics.' },
  { id: 'glimmer', name: 'Glimmer Cave', x: 196, y: 44, map: 'glimmercave', fly: false, desc: 'A cave lined with singing crystals.' },
  { id: 'cindervale', name: 'Cindervale', x: 246, y: 38, map: 'cindervale', fx: 21, fy: 20, fly: true, desc: 'Hot springs and forges at the foot of a volcano.' },
  ...
  { id: 'tidelight', name: 'Lodestar Isle', x: 190, y: 116, map: 'tidelight', fx: 11, fy: 17, fly: true, desc: 'The island lighthouse at the heart of the Mere.' },
...
Object.assign(G.QUESTS, {
  ...
  main7: { name: 'Skyreach Rising', main: true, desc: 'Cross Mt. Glacia to Skyreach City. Something is wrong at Crane Dynamics HQ.', doneText: 'Crane fled to the Lodestar. Kaelen\'s Wyrm Badge is yours.' },
  main8: { name: 'The Lodestar', main: true, desc: 'Sail Route 6 to Lodestar Isle and stop Director Crane.', doneText: 'The song of Orrelume is free again.' },
  ...
  side_fossil: { name: 'Bones of the Past', giver: 'Dr. Orla', desc: 'Bring a fossil from Glimmer Cave to the Galvan Harbor Museum to be revived.', reward: 'An ancient Echo', doneText: 'An ancient Echo lives again.' },
  side_spring: { name: 'Hot Spring Hopper', giver: 'Attendant Kiko', desc: 'Kiko at the Cindervale hot springs wants to see a Fire, Water, and Ice Echo relax together. Show her one of each type in your party.', reward: 'Leftovers', doneText: 'The springs have never been cozier.' },
...
// ------------------------------------------------------------ chapters ---
G.CHAPTERS = [
  { name: '1 · Just got a starter (Brinehollow)', map: 'brinehollow', x: 18, y: 9, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done'], items: ['dex', 'journal', 'orb', 'potion'], party: [['kindlet', 6]], freshParty: true, lvl: 6 },
  { name: '2 · Fernwick (deliver parcel)', map: 'fernwick', x: 21, y: 19, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done', 'route1_tut'], items: ['dex', 'journal', 'parcel'], party: [['kindlet', 11], ['pipwing', 9]], freshParty: true, lvl: 11, visited: ['brinehollow', 'fernwick'] },
  { name: '3 · Whisperwood (after badge 1)', map: 'fernwick', x: 21, y: 19, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done', 'route1_tut', 'parcel_given', 'badge1'], badges: ['bloom'], items: ['dex', 'journal'], party: [['pyrolynx', 16], ['gustling', 14], ['mossbun', 13]], freshParty: true, lvl: 14, visited: ['brinehollow', 'fernwick'] },
  { name: '4 · Galvan Harbor (gym 2)', map: 'galvan', x: 22, y: 19, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done', 'route1_tut', 'parcel_given', 'badge1', 'wood_done', 'crane_speech'], badges: ['bloom'], items: ['dex', 'journal', 'resonanceband', 'expshare', 'trailknife'], party: [['pyrolynx', 19], ['gustling', 18], ['voltpup', 17], ['aurorymoth', 17]], freshParty: true, lvl: 18, visited: ['brinehollow', 'fernwick', 'galvan'] },
  { name: '5 · Route 3 / Glimmer Cave', map: 'galvan', x: 22, y: 19, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done', 'route1_tut', 'parcel_given', 'badge1', 'wood_done', 'crane_speech', 'badge2', 'got_bike'], badges: ['bloom', 'current'], items: ['dex', 'journal', 'resonanceband', 'expshare', 'trailknife', 'bike', 'rod'], party: [['pyrolynx', 22], ['gustling', 21], ['voltpup', 21], ['aurorymoth', 20], ['digmole', 19]], freshParty: true, lvl: 21, visited: ['brinehollow', 'fernwick', 'galvan'] },
  { name: '6 · Cindervale (gym 3)', map: 'cindervale', x: 21, y: 20, flags: ['intro_done', 'mom_talk', 'got_starter', 'rival1_done', 'route1_tut', 'parcel_given', 'badge1', 'wood_done', 'crane_speech', 'badge2', 'got_bike', 'lark1_done', 'rival2_done'], badges: ['bloom', 'current'], items: ['dex', 'journal', 'resonanceband', 'expshare', 'trailknife', 'bike', 'rod', 'pickhammer'], party: [['pyrolynx', 25], ['gustling', 24], ['stormhound', 26], ['aurorymoth', 24], ['digmole', 23], ['lillipad', 23]], freshParty: true, lvl: 24, visited: ['brinehollow', 'fernwick', 'galvan', 'cindervale'] },
