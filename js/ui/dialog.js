...
// ============================================================================
G.settings = G.settings || { textSpeed: 2, music: .7, sfx: .8, battleAnims: true, battleStyle: 'switch', battleSpeed: 1, autoRun: false, fill: false, hints: true, dmgPreview: false, clock: 'accel', autosave: true, ffSpeed: 3, ffMode: 'toggle', render3d: true };
